...
Partial Class Form_Kelola_Wahana_Karyawan
    ...
    Private Sub InitializeComponent()
        ...
        Controls.Add(Label1)
        Name = "Form_Kelola_Wahana_Karyawan"
        Text = "Form_Kelola_Wahana_Karyawan"
