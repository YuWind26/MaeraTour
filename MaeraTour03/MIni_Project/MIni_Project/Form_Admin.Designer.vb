...
Partial Class Form_Admin
    ...
    Private Sub InitializeComponent()
        ...
        ' Btn_User
        ' 
        Btn_User.BackColor = Color.FromArgb(CByte(68), CByte(71), CByte(101))
        ...
        Btn_User.Location = New Point(170, 147)
        Btn_User.Name = "Btn_User"
        Btn_User.Size = New Size(170, 80)
        Btn_User.TabIndex = 0
        Btn_User.Text = "User"
        ...
        Btn_Tempat_Wisata.Location = New Point(440, 147)
        Btn_Tempat_Wisata.Name = "Btn_Tempat_Wisata"
        Btn_Tempat_Wisata.Size = New Size(170, 80)
        Btn_Tempat_Wisata.TabIndex = 1
        Btn_Tempat_Wisata.Text = "Tempat Wisata"
        Btn_Tempat_Wisata.UseVisualStyleBackColor = False
        ' 
        ' Btn_Gaji
        ' 
        Btn_Gaji.BackColor = Color.FromArgb(CByte(68), CByte(71), CByte(101))
        Btn_Gaji.FlatAppearance.BorderSize = 0
        Btn_Gaji.FlatStyle = FlatStyle.Flat
        Btn_Gaji.Font = New Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point)
        Btn_Gaji.ForeColor = Color.White
        Btn_Gaji.Location = New Point(170, 261)
        Btn_Gaji.Name = "Btn_Gaji"
        Btn_Gaji.Size = New Size(170, 80)
        Btn_Gaji.TabIndex = 2
        Btn_Gaji.Text = "Gaji Karyawan"
        Btn_Gaji.UseVisualStyleBackColor = False
        ' 
        ' Btn_Laporan
        ' 
        ...
        Btn_Laporan.Location = New Point(440, 261)
        Btn_Laporan.Name = "Btn_Laporan"
        Btn_Laporan.Size = New Size(170, 80)
        Btn_Laporan.TabIndex = 3
        ...
        Btn_Logout.Location = New Point(638, 24)
